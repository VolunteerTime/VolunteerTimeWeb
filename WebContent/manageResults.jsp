...
<%@page import="scau.info.volunteertime.vo.Result"%>

<%@page import="com.chao.tool.*"%>
<%@page import="scau.info.volunteertime.dao.resultsexhibition.*"%>
...
<%
	...
	int Page = 1;
	List list = null;
	ResultsExhibitionDao resultsExhibitionDao = new ResultsExhibitionDaoImpl();
	if (str == null) {
		list = resultsExhibitionDao.getAll(messagekeyword);
...
<script type="text/javascript">
	...
	function toClickDeleteMessage(id) {
		createXMLHttp();
		xmlHttp.open("POST",
				"/VolunteerTimeWeb/VolunteerTimeResultExhibitionServlet?action_type=6&id="
						+ id);
				...
				<ul id="main-nav">
					...
					<li><a href="#" class="nav-top-item current"> <!-- Add the class "current" to current menu item -->
						...
						<ul class="dropdown">
							...
							<li><a href="manageResults.jsp" class="current">成果管理</a></li>
						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td><%=result.getEditor()%></td>
									<td><%=Util.getTime(result.getPublishTime(),
			...
			<div class="content-box " id="writeMess">
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab">
						...
						<form
							action="/VolunteerTimeWeb/VolunteerTimeResultExhibitionServlet?action_type=5"
